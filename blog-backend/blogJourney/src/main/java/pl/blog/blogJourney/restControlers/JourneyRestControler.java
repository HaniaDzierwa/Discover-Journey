...
public class JourneyRestControler {
    ...
    public Set<JourneyResponse> getAllJourneys() {
        ...
        return journeyRepository.findAll()
                .stream()
                .map(p -> new JourneyResponse(p.getName(), p.getDescription(), p.getMonth()))
                .collect(Collectors.toSet());
    }


    @GetMapping("journeys/{tagsRequest}")
    public Set<JourneyResponse> getAllJourneysWithTag(@RequestParam Set<TagDto> tagsRequest) {
        ...
        return journeyRepository.findAll()
                ...
                .map(p ->
                        new JourneyResponse(p.getName(), p.getDescription(), p.getMonth()))
                .collect(Collectors.toSet());
    }
    ...
    public List<JourneyPointResponse> getJourneyPoints(@RequestParam long journeyId) {
